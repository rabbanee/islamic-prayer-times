...
IslamicPrayerTimesModel islamicPrayerTimesModelFromJson(String str) =>
    IslamicPrayerTimesModel.fromJson(json.decode(str));

String islamicPrayerTimesModelToJson(IslamicPrayerTimesModel data) =>
    json.encode(data.toJson());

class IslamicPrayerTimesModel {
  IslamicPrayerTimesModel({
    this.code,
    this.status,
    this.results,
  });
  ...
  factory IslamicPrayerTimesModel.fromJson(Map<String, dynamic> json) =>
      IslamicPrayerTimesModel(
        code: json["code"],
        status: json["status"],
